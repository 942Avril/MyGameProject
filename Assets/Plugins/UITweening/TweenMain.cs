...
namespace UnityEngine.UI
{
    public abstract class TweenMain : MonoBehaviour
    {
        ...
        #region components
        private UnityEngine.UI.Graphic _gfx;
        protected UnityEngine.UI.Graphic gfx
        {
            get
            {
                if (_gfx == null)
                    _gfx = GetComponent<UnityEngine.UI.Graphic>();
                return _gfx;
            }
        }
        ...
        public void SetFinished(UnityAction finished)
        {
            OnFinished.AddListener(finished);
        }
    }
}

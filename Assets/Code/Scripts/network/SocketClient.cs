...
public class SocketClient : MonoBehaviour {
	...
	private static string java_publickey = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC+uQ6CRdc/z8leYVyaiW/k5D/E9GHDne1YxZPyInc7mGeiLc1h3EP0czI+wQz1BfLeKJYdtrd7IwpmDlcrkKJ2Dy4wLYRzHujG5/3Un7629Hf2pCBuoPttZna1YT3HHu5obFpt3g93tzdw4gn4j2la8vdmgQtQBR98TeLNfS0QoQIDAQAB";
	private static string java_privatekey = "";
	...
	void OnReceive(byte[] bytes, int length)
	{
		...
		for(i = 0, start = 0; i < z_reader.eobcnt; start = z_reader.eob[i], ++i)
		{
			...
			case Session.SESSION_VERIFY_FAILED:
				break;
            default:
                throw new System.Exception("state error");
			}
		}
